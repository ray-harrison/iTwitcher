...
#define kFlickrAPIKey @"8f66063481344710c97b6340062617c6"

@implementation Flickr

+ (NSString *)flickrSearchURLForSearchTerm:(NSString *) searchTerm
{
    searchTerm = [searchTerm stringByAppendingString:@" bird"];
    searchTerm = [searchTerm stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    return [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=%@&text=%@&per_page=5&pages=1&format=json&nojsoncallback=1&is_commons&license=4,7&has_geo=1&extras=original_format,tags,description,geo,date_upload,owner_name,place_ur",kFlickrAPIKey,searchTerm];
}
