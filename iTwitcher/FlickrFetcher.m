...
+(NSArray *) speciesPhotos:(NSString *)speciesName
{
    NSString *request = [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&text=%@&pages=1&per_page=5&is_commons&license=4,7&has_geo=1&extras=original_format,tags,description,geo,date_upload,owner_name,place_url",speciesName];
    return [[self executeFlickrFetch:request] valueForKeyPath:@"photos.photo"];
