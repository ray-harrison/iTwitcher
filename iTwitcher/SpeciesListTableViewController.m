...
//  iTwitcher
//
//  Created by Raymond Harrison on 3/17/13.
...
- (void)viewDidLoad
{
    ...
    self.mySpeciesList = [Species speciesWithObservations:[self.birdDatabase managedObjectContext]];
 //   NSLog(@"Count of Locations %d",[[ObservationLocation queryObservationLocations:[self.birdDatabase managedObjectContext] bySpeciesName:@"American Goldfinch"] count]);
}
